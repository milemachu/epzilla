...
public class SimpleStructure extends jstm.core.TransactedStructure {
    ...
    public jstm.tests.generated.test.SimpleStructure2 getEntity2() {
        return (jstm.tests.generated.test.SimpleStructure2) getField(4);
    }

    public void setEntity2(jstm.tests.generated.test.SimpleStructure2 value) {
        setField(4, value);
    }
    ...
    public static final int ENTITY2_INDEX = 4;

    public static final String ENTITY2_NAME = "Entity2";
    ...
    public void method(String sql, jstm.tests.generated.SimpleStructure eg, MethodCallback<String> callback) {
        addCall(0, new Object[] { sql, eg }, callback);
    }

    protected String method(String sql, jstm.tests.generated.SimpleStructure eg) {
    ...
    private static final int[] NON_TRANSIENT_FIELDS = new int[] { 3, 4 };
        ...
        if (values != null) {
            ...
            if (values[4] != null) {
                if (values[4] == Removal.Instance)
                    ...
                    writer.writeShort((short) 5);
                    writer.writeTransactedObject((TransactedObject) values[4]);
                }
            }
        }
    ...
    protected void deserialize(TransactedObject.Version version, Reader reader) throws java.io.IOException {
        ...
        if (index == 5) {
            ...
            values[4] = reader.readTransactedObject();
            index = reader.readShort();
        } else if (index == -5) {
            if (values == null)
                values = new Object[5];
    ...
    protected Object call(int index, Object[] args) {
        switch (index) {
            case 0:
                return method((String) args[0], (jstm.tests.generated.SimpleStructure) args[1]);
            default:
    ...
    protected void serializeArguments(int index, Object[] values, Writer writer) throws java.io.IOException {
        switch (index) {
            case 0: {
                writer.writeString((String) values[0]);
                writer.writeTransactedObject((TransactedObject) values[1]);
                break;
            }
            default:
                throw new java.lang.IllegalStateException();
    ...
    protected Object[] deserializeArguments(int index, Reader reader) throws java.io.IOException {
        switch (index) {
            case 0: {
                ...
                values[0] = reader.readString();
                values[1] = reader.readTransactedObject();
                return values;
            }
            default:
                throw new java.lang.IllegalStateException();
