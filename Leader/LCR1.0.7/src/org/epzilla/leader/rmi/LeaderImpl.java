...
public class LeaderImpl extends UnicastRemoteObject implements LeaderInterface {
	...
	/**
	 * This method will be called  when the client start to register them to receive message/event 
	 * from the leader
	 */
	...
	/**
	 * This method is used to unregister a registered user from receiving events from the leader. 
	 */
