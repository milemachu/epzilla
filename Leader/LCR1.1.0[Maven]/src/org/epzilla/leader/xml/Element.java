...
//   import com.mubasher.netproxy.nanoxml.XMLParseException;
   ...
   /**
* Element is a representation of an XML object. The object is able to parse
* XML code.
* <P><DL>
...
* </DD></DL>
* <DL><DT><B>Subclassing Element</B></DT>
* <DD>
...
* <ul><li>The field can be empty.
* <li>The field is never <code>null</code>.
* <li>The elements are instances of <code>Element</code>
* or a subclass of <code>Element</code>.
* </ul></dd></dl>
*/
...
* <ul><code>new Element(new Hashtable(), false, true)
* </code></ul>
* <p/>
...
* </ul></dd></dl>
*
* @see Element#Element(java.util.Hashtable)
*      Element(Hashtable)
* @see Element# Element (boolean)
* @see Element# Element (java.util.Hashtable,boolean)
...
* Creates and initializes a new XML element.
* Calling the construction is equivalent to:
* <ul><code>new Element(entities, false, true)
* </code></ul>
*
...
* Creates and initializes a new XML element.
* Calling the construction is equivalent to:
* <ul><code>new Element(new Hashtable(), skipLeadingWhitespace, true)
* </code></ul>
*
...
*                              <p/>
*                              Element#Element()
*                              Element#Element(java.util.Hashtable)
*                              Element(Hashtable)
...
* Creates and initializes a new XML element.
* Calling the construction is equivalent to:
* <ul><code>new Element(entities, skipLeadingWhitespace, true)
* </code></ul>
*
* @param entities              The entity conversion table.
* @param skipLeadingWhitespace <code>true</code> if leading and trailing whitespace in PCDATA
...
*/
   protected Element(Hashtable entities,
                    boolean skipLeadingWhitespace,
...
*              Element#getChildren()
*              Element#removeChild(nanoxml.Element)
*              removeChild(Element)
*/
...
* </ul></dd></dl>
* <p/>
* Element#addChild(nanoxml.Element)
* addChild(Element)
* Element#enumerateChildren()
* Element#getChildren()
* Element#removeChild(nanoxml.Element)
...
* <CODE>null</CODE> is returned.
* <p/>
* Element#setContent(java.lang.String)
* setContent(String)
*/
...
*/
   ...
   return new Element(this.entities,
...
*            </ul></dd></dl>
*/
   protected void scanElement(Element elt)
       throws IOException {
