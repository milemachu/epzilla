...
package net.epzilla.accumulator.generated;
...
public final class AccumulatorObjectModel extends jstm.core.ObjectModel {
    ...
    public TransactedObject createInstance(int classId, Connection route) {
        switch (classId) {
            case 0:
                return new net.epzilla.accumulator.generated.SharedDerivedEvent();
            case 1:
                return new net.epzilla.accumulator.generated.StructureMarker();
        }
