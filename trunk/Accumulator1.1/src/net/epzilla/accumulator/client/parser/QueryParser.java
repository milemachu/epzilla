package net.epzilla.accumulator.client.parser;

import net.epzilla.accumulator.client.query.Query;
import net.epzilla.accumulator.client.query.QuerySyntaxException;
import net.epzilla.accumulator.client.query.QueryType;
