...
//         String query = EventTriggerGenerator.getNextTrigger();
         String query = "SELECT CarDetails.Year WHERE CarDetails.Year=1994 OUTPUT AS CarDetailsResults";
         String query2 = "SELECT CarDetails.Model WHERE CarDetails.Year=1994 OUTPUT AS CarDetailsResults";
