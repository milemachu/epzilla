...
//		li.receiveMessage(Message.getInstance().getRequestNotAccepted()+400+MessageMeta.SEPARATOR);
	...
	public static void sendUidMessage(String remoteIp)
		...
		System.out.println("Recived UID is higher or same order. This UID sent to:"
				+ remoteIp);
	}
	...
	/**
	 * If s host is unable to accepted a message to not authorized to reply, this message is sent. 
	 * @param remoteIp
	 * @throws MalformedURLException
	 * @throws RemoteException
	 * @throws NotBoundException
	 * @throws UnknownHostException
	 */
	public static void sendRequestNotAccepted(String remoteIp, int errorCode) throws MalformedURLException, RemoteException, NotBoundException, UnknownHostException {
		LeaderInterface li = getLeaderInterface(remoteIp);

		li.receiveMessage(Message.getInstance().getRequestNotAccepted()+errorCode+MessageMeta.SEPARATOR);
	 ...
	 * @throws UnknownHostException
	 */
	public static void sendPing(String remoteIp) throws MalformedURLException, RemoteException, NotBoundException, UnknownHostException{
		LeaderInterface li = getLeaderInterface(remoteIp);
	...
	/**
	 * This is used to get the Leader address from a remote machine without running a Leader Election.
	 * @param remoteIp
	 * @return
	 * @throws MalformedURLException
	 * @throws RemoteException
	 ...
	 * @throws UnknownHostException
	 */
	public static String getClusterLeaderFromRemote(String remoteIp) throws MalformedURLException, RemoteException, NotBoundException, UnknownHostException{
		LeaderInterface li = getLeaderInterface(remoteIp);		
	 ...
	 * @throws NotBoundException
	 */
	public static String getStateFromRemote(String remoteIp) throws MalformedURLException, RemoteException, NotBoundException{
		LeaderInterface li = getLeaderInterface(remoteIp);		
	 ...
	 * @throws NotBoundException
	 */
	public static boolean isLeaderElectioRunningInRemote(String remoteIp) throws MalformedURLException, RemoteException, NotBoundException{
		LeaderInterface li=getLeaderInterface(remoteIp);
