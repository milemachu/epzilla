		...
		if (strArray != null && Integer.parseInt(strArray[1]) >= 1) {
			...
			if (receivedUid == EpzillaProcess.UID) {
				...
				try {
					...
					// list
					LeaderMessageClient
							.sendLeaderElectedMessage(EpzillaProcess.getInstance().getIpNextToThis());
				...
				try {
					...
					LeaderMessageClient.forwardReceivedUidMessage(EpzillaProcess.getInstance().getIpNextToThis(), message);
				} catch (MalformedURLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} catch (RemoteException e) {
				...
				try {
					LeaderMessageClient.sendUidMessage(EpzillaProcess.getInstance().getIpNextToThis());
				} catch (MalformedURLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				} catch (RemoteException e) {
