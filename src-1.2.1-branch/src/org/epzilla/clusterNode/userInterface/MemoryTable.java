...
public class MemoryTable extends JPanel {
    ...
    public class DisplayPanel extends JPanel {
        ...
        public void paint(Graphics g) {
            ...
            float maxRate = CpuMemAnalyzer.getTotalMemory();
            float free = CpuMemAnalyzer.getFreeMemory();

            graphics.setColor(GREEN);
            graphics.drawString(String.valueOf((int) (maxRate)) + " MB (Total memory)", 4.0f, (float) aH + 0.5f);
